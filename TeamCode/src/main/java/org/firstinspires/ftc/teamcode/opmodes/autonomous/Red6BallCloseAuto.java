...
@Configurable
@Autonomous(name = "6 Red Ball Close Auto")
public class Red6BallCloseAuto extends NextFTCOpMode {
    public Red6BallCloseAuto() {
        addComponents(
...
//                shootWithTransfer(),
    ...
    private final Pose scoringPose = new Pose(87, 89, Math.toRadians(230));
