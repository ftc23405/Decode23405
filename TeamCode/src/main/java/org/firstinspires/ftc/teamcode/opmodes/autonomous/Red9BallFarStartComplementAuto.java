...
@Configurable
@Autonomous(name = "Complementary 9 Ball Red Side Far Auto")
public class Red9BallFarStartComplementAuto extends NextFTCOpMode{

    public Red9BallFarStartComplementAuto() {
        addComponents(
