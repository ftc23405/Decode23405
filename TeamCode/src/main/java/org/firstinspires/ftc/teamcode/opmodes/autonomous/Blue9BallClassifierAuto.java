...
public class Blue9BallClassifierAuto extends NextFTCOpMode {
    ...
    private final Pose startPose = new Pose(118.000, 130.500, Math.toRadians(216)).mirror();
    private final Pose scoringPose = new Pose(92.632, 107.117, Math.toRadians(225)).mirror();

    private final Pose intakePose1 = new Pose(129.150, 83.990, Math.toRadians(0)).mirror();
    private final Pose intakeShortControlPose1 = new Pose(74.982, 89.224).mirror();
