...
@Configurable
@Autonomous(name = "9 Ball Blue Classifier Auto")
public class BlueClassifierAuto extends NextFTCOpMode {
    ...
    private final Pose startPose = new Pose(26.000, 129.000, Math.toRadians(-44));
    private final Pose scoringPose = new Pose(59.036, 108.578, Math.toRadians(-35));

    private final Pose intakePose1 = new Pose(19.354, 83.868, Math.toRadians(180));
    private final Pose intakeShortControlPose1 = new Pose(73.278, 98.597);
    private final Pose intakeShortControlPose2 = new Pose(76.078, 87.398);
    private final Pose intakeShortControlPose3 = new Pose(63.418, 85.085);

    private final Pose goBackShortControlPose1 = new Pose(75.347, 82.529);

    private final Pose intakePose2 = new Pose(18.259, 59.888, Math.toRadians(180));
    private final Pose intakeLongControlPose1 = new Pose(94.336, 84.964);
    private final Pose intakeLongControlPose2 = new Pose(51.855, 62.688);
    private final Pose intakeLongControlPose3 = new Pose(97.258, 59.645);

    private final Pose endPose = new Pose(20.693, 69.992, Math.toRadians(0));
