...
public class Blue3BallFarAuto extends NextFTCOpMode {
    ...
    private final Pose scoringPose = new Pose(84.233, 18.989, Math.toRadians(-121)).mirror();

    private final Pose turnPose = new Pose(97.461, 34.435, Math.toRadians(0)).mirror();

    private final Pose intakePose1 = new Pose(131.687, 34.852, Math.toRadians(0)).mirror();

    private final Pose endPose = new Pose(118, 9, Math.toRadians(180)).mirror();
